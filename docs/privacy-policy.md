...
_Effective 19 September 2026._

This policy covers the Wasfati app ("the app"). <!-- Update it in every PR that adds or changes what the app stores, shares, or requests. Remove sections that don't apply. -->
